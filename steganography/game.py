...
class five_chess():
    ...
    def __init__(self):
        ...
        self.move_numbers = [[0 for _ in range(15)] for _ in range(15)]  # 添加这一行
        self.turn = 'player'
        self.move_count = 0  # Define move_count here
        self.run()
    ...
    def run(self):
        ...
        boardImage = pygame.image.load('pic/board1.jpg')
        ...
        pygame.display.set_caption('Behavioral Information Hiding Terminal by h_key')
        ...
        while True:
            ...
            if gameOver == False and self.turn == 'computer':
                ...
                print(f"[{blue}{datetime.datetime.now().strftime('%H:%M:%S')}{end}] [{green}TIME{end}] {elapsed_time} s")
                self.board[move[0]][move[1]] = 2
                self.move_count += 1
                self.move_numbers[move[0]][move[1]] = self.move_count
